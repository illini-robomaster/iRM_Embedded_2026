...
constexpr int MOTOR_RANGE = 16384;  // TODO: 32767 or 30000?
 ...
 */
    ...
    public:
        ...
        void SetMaxCurrent(servo_t data, const float max_current);
    ...
    private:
        ...
        bool zeroing_exit; /* flag to exit zeroing */
        // angle control
