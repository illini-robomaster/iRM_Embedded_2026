...
class MotorCANBase : public MotorBase {
 public:
  ...
  /**
   * @brief get the CAN instance
   * @return pointer to the CAN instance
   */
  bsp::CAN* GetCan() const { return can_; }

  /**
   * @brief get the CAN rx id
   * @return CAN rx id
   */
  uint16_t GetRxId() const { return rx_id_; }
