...
/**
  * @brief  Exit Run0 mode to enable full voltage range (VOS1) for STM32H7
  * @note   This function is called from the startup file before main()
  *         STM32H723 powers up in VOS3 by default, need to switch to VOS1 for 550 MHz operation
  * @retval None
  */
